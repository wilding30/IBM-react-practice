                                    ...
                                    {avItems.map((item, index) =>(
                                        <div className="av_data venue_main" key={index}>
                                            ...
                                            <div className="addon_btn">
                                                <button className="btn-warning" conClick={()_ => handleDecrementAvQuantity(item)}> &ndash; </button>
                                                <span className="quantity-value">{item.quantity}</span>
                                                <button className="btn-success" onClick={() => handleIncrementAvQuantity(item)}> &#43; </button>
                                            </div>
                                        </div>
                                    ))}
                                </div>
